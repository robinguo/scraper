...
CREATE TABLE `listing` (
  ...
  `is_business_travel_ready` tinyint(11) DEFAULT NULL,
  `instant_bookable` tinyint(11) DEFAULT NULL,
  `city` varchar(32) DEFAULT NULL,
  `accomodates` tinyint(4) DEFAULT NULL,
  `bathrooms` tinyint(4) DEFAULT NULL,
  `bedrooms` tinyint(4) DEFAULT NULL,
  `beds` tinyint(4) DEFAULT NULL,
  `check_in_min` tinyint(4) DEFAULT NULL,
  `check_in_max` tinyint(4) DEFAULT NULL,
  `check_out` tinyint(4) DEFAULT NULL,
  `property_type` varchar(16) DEFAULT NULL,
  `room_type` varchar(16) DEFAULT NULL,
  `bed_type` varchar(16) DEFAULT NULL,
  `pet_owner` varchar(16) DEFAULT NULL,
  `cancellation_policy` varchar(16) DEFAULT NULL,
  `cleaning_fee` varchar(16) DEFAULT NULL,
  `extra_people` varchar(16) DEFAULT NULL,
  `monthly_discount` varchar(16) DEFAULT NULL,
  `monthly_price` varchar(16) DEFAULT NULL,
  `permit` varchar(16) DEFAULT NULL,
  `security_deposit` varchar(16) DEFAULT NULL,
  `weekly_discount` varchar(16) DEFAULT NULL,
  `weekly_price` varchar(16) DEFAULT NULL,
  `weekend_price` varchar(16) DEFAULT NULL,
  `description` text DEFAULT NULL,
  `house_rules` text DEFAULT NULL,
  `building_rules` text DEFAULT NULL,
  ...
  `response_time_shown` tinyint(4) DEFAULT NULL,
